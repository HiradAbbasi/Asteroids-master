...
public class Asteroid extends SmoothMover
{
     ...
     */
    /**
     * setSize- sets the stability varriable to be initinilized to size and also sclaes the
     * image to the right size.
     * 
     * @param There is an integer size as the parameters
     * @return Nothing is returned
     */
     ...
     */
     /**
     * hit- addsmscore to the score board and also breaks the Asteroid into 3 pieces after getting 
     * shot by the player.
     * 
     * @param There is an integer damage as the parametres
     * @return Nothing is returned
     */
    ...
    /**
     * breakUp- Helps to break the asteroid into samller pieces after getting shot by the rocket.
     * 
     * @param There is an integer numBreakUp as the parameters
     * @return Nothing is returned
     */
