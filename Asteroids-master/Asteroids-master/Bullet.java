...
public class Bullet extends SmoothMover
{
    ...
    /** A bullet looses one life eac act, and will disappear when life = 0 */
    private int life = 30;
    ...
    /**
     * checkAsteroidHit- checks to see if the aste been hit. If true, the asteroid is hit with 
     * damage and later removed from the game.
     * 
